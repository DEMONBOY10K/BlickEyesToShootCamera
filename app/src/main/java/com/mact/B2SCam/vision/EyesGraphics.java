 ...
 */
package com.mact.B2SCam.vision;
...
//    private Activity EyesActivity;
    ...
    public EyesGraphics(GraphicOverlay overlay) {
        ...
        mEyeLidPaint.setColor(Color.rgb(150, 81, 226));
    ...
    public void draw(Canvas canvas) {
        ...
        EyesActivity e = new EyesActivity();
    ...
    public  void drawEye(Canvas canvas, PointF eyePosition, float eyeRadius,
