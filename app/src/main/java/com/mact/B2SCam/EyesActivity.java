...
import com.mact.B2SCam.vision.CameraSourcePreview;
import com.mact.B2SCam.vision.FaceTracker;
import com.mact.B2SCam.vision.GraphicOverlay;
...
public final class EyesActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(view -> {
            Intent i = new Intent(EyesActivity.this,Home.class);
            startActivity(i);
            finish();
        });
    ...
    private void createCameraSource() {
        ...
        mCameraSource = new CameraSource.Builder(context, detector)
                .setFacing(facing)
                .setRequestedPreviewSize(500, 600)
